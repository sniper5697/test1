          ...
          >
            <label style={{ display: "grid", gap: 8 }}>
              ...
              <input
                ...
                style={errors.name ? { borderColor: "#ff6b81", boxShadow: "inset 0 0 0 1px #ff6b81" } : undefined}
              />
              <span
            ...
            <label style={{ display: "grid", gap: 8 }}>
              ...
              <input
                ...
                style={errors.email ? { borderColor: "#ff6b81", boxShadow: "inset 0 0 0 1px #ff6b81" } : undefined}
              />
              <span
